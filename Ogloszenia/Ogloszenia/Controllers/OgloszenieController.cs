...
namespace Ogloszenia.Controllers
{
    public class OgloszenieController : Controller
    {
        ...
        {
            db.Database.Log = message => Trace.WriteLine(message);//pokazuje zapytanie do bazy w output
            // var ogloszenia = db.Ogloszenia.Include(o => o.Uzykownik); // wyłącza LazyLoading
            var ogloszenia = db.Ogloszenia.AsNoTracking(); //wyl śledzenie przez kontekst, uzywa lazyloading
